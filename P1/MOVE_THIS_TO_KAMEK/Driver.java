...
public class Driver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        parseArgs(args);  // handles args, comes back to this point -- dont worry about this
      

        Matching problem = parseMatchingProblem(filename); // read in input 
        testRun(problem);
        long endTime = System.nanoTime();
        long timeElapsed = endTime - startTime;

		System.out.println("Execution time in nanoseconds  : " + timeElapsed);
		long millisecond = timeElapsed / 1000000;
    ...
    public static void parseArgs(String[] args) {
        ...
        for (String s : args) {
            if (s.equals("-gl")) {
                ...
                filename = "large_inputs/320.in"; //TODO: SET THIS MANUALLY
            } else {
